...
const PhoneLoginPresenter: React.SFC<IProps> = ({
  ...
  <div css={Container}>
    ...
    <BackArrow css={BackArrowExtended} backTo={'/'} />
    <h2 css={Title}>Enter your mobile number</h2>
    <select css={CountrySelect} value={countryCode} name={'countryCode'} onChange={onInputChange}>
      {countries.map((country, index) => (
        <option css={CountryOption} key={index} value={country.dial_code}>
